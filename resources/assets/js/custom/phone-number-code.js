...
$(document).ready(function () {
    ...
    $.each(data.countries, function (i, v) {
        $('.default-region-code-ul .default-region-code-ul-div').append(`
         <li>
    ...
    $('.default-region-code-li-country').each(function () {
        if (typeof defaultRegionCode !== 'undefined') {
            if ($(this).find('.region-code-li-country-code').attr('id') ===
                defaultRegionCode) {
                $(this).addClass('selected');
            }
    ...
    $(document).on('click', '.default-region-code-li-country', function () {
        ...
        $(this).addClass('selected');
        let btnCc = $(this).
            parents('.region-codes').
            find('.btn-cc');
        let defaultInputCc = $(this).parents('.region-codes').next();
        let defaultInputFlag = $(this).parents('.region-codes').next().next();
        let callingCode = $(this).find('.callingCode').attr('id');
        let flag = $(this).find('.flag').attr('id');
        $(this).
            parents('.region-codes').
        ...
        defaultInputFlag.val(flag);
        $('.default-region-code-ul').val('');
        $('.default-region-code-ul').keyup();
    });
    ...
    $(document).on('keyup', '.default-search-country', function () {
        let searchTerm = $(this).val().toLowerCase();
        $('.default-region-code-ul li a').filter(function () {
            $(this).
                toggle($(this).text().toLowerCase().indexOf(searchTerm) > -1);
            // checkIfEmpty();
        });
