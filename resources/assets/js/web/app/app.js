...
$(document).ready(function () {
    ...
    $('#wrapper').on('click', function () {
        ...
        $('.overlay-body').addClass('overlay-body-show');
    });
    ...
    $('.overlay-body').click(function () {
        ...
        $(this).removeClass('overlay-body-show');
    });
    ...
    $('.custom_web_navbar li').on('click', function () {
        ...
        $('.overlay-body').removeClass('overlay-body-show');
    });
    ...
    function checkSize () {
        ...
        if ($('.overlay-body').hasClass('overlay-body-show')) {
            $('.overlay-body').removeClass('overlay-body-show');
        }
    }
