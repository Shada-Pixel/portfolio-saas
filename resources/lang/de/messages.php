...
return [
    ...
    */
    ...
    'remaining_characters'              => 'Verbleibende Charaktere',
    'subscription_month_plan_not_found' => 'Wir konnten keine Monatsabos finden',
    ...
    'enter_support'           => 'Betreten Sie den Support',
    ...
    //    featured 
    'featured_portfolio' => [
        'portfolio'                  => 'Ausgewähltes Portfolios',
        'featured'                   => 'Empfohlen',
        'no_feature_portfolio_found' => 'Wir konnten keine vorgestellten Portfolios finden',
    ],
    ...
    'default_prefix_code'         => 'Standardpräfixcode',
    ...
    'subscription_plans'         => [
        'add_subscription_plan'  => 'Abonnement hinzufügen',
        'name'                   => 'Name',
        'currency'               => 'Währung',
        'price'                  => 'Preis',
    ...
    'vCards'                     => [
        'VCards'                   => 'vCards',
        'new_vcards'               => 'Neue vCard hinzufügen',
        'v_card_name'              => 'vCard-Name',
        'template'                 => 'Vorlage',
        'occupation'               => 'Beruf',
        'introduction'             => 'Einführung',
        'preview'                  => 'Vorschau',
        'new_vCards'               => 'vCards erstellen',
        'choose_template'          => 'Wählen Sie eine Vorlage',
        'profile_image'            => 'Profilbild',
        'cover_image'              => 'Titelbild',
        'add_information'          => 'Information hinzufügen',
        'Icons'                    => 'Symbole',
        'color'                    => 'Farbe',
        'label'                    => 'Etikett',
        'value'                    => 'Wert',
        'vcards_details'           => 'vCard-Details',
        'edit_vcard'               => 'vCard bearbeiten',
        'edit_v_card_attribute'    => 'vCard-Attribut bearbeiten',
        'v_card_attribute'         => 'vCard-Attribut',
        'preview_template'         => 'Vorschau-Vorlage',
        'cover_image_resolution'   => 'Die beste Auflösung für dieses Titelbild-Symbol ist 210 x 420.',
        'profile_image_resolution' => 'Die beste Auflösung für dieses Profilbildsymbol ist 100 x 100.',
        'copy_url'                 => 'URL kopieren',
        'url'                      => 'URL',
        'our_service'              => 'Unser Service',
        'testimonial'              => 'Zeugnis',
        'share_vcard'              => 'vCard teilen',
        'share_on'                 => 'Teilen auf',
        'vCards_placeholder'       => [
            'enter_vCards_name'         => 'Geben Sie einen vCard-Namen ein',
            'enter_name'                => 'Geben Sie einen Namen ein',
            'enter_vCards_occupation'   => 'Geben Sie einen Beruf ein',
            'enter_vCards_introduction' => 'Geben Sie eine Einführung ein',
            'enter_label_name'          => 'Geben Sie einen Labelnamen ein',
            'enter_value'               => 'Geben Sie eine URL ein',
        ],
    ],
    ...
    'subscription_pricing_plans' => [
        ...
        'no_pricing_plan_found'     => 'Wir konnten keine Abonnements finden',
        'renew_free_plan'           => 'Free Plan kann nicht verlängert/ausgewählt werden',
    ],

    'followers' => [
        'follower_following' => 'Follower/Folgen',
        'follower'           => 'Anhängerin',
        'followers'          => 'Anhänger',
        'following'          => 'Folge',
        'unfollow'           => 'Folgen',
    ...
    'qr_code' => [
        'add_new_qr_code'   => 'Neuen QR-Code hinzufügen',
        'create_qr_code'    => 'QR-Code erstellen',
        ...
        'size'              => 'Größe',
        'white_space'       => 'Weißraum',
        'style'             => 'Stil',
        'eye_style'         => 'Augenstil',
        'edit_qrcode'       => 'QRCode bearbeiten',
        'download'          => 'Herunterladen',
        'color_text'        => 'QR-Code kann nicht gescannt werden, wählen Sie eine dunklere Farbe.',
    ],
];
