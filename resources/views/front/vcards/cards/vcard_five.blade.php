...
@endsection
@section('page_css')
    <link href="{{ asset('assets/css/web/vcards/vcards-five.css') }}" rel="stylesheet" type="text/css"/>
@endsection
@section('content')
    <div class="container p-0">
        <div class="vcard-page-content position-relative">
            ...
            <div>
                <img src="{{ !empty($vcard->cover_image) ? $vcard->cover_image :  asset('assets/web/css/images/vcard_five.jpeg')  }}"
                     class="vcard-page-banner vcard_bg_cover_five">
            </div>
            <div class="admin_wrapper_card d-flex justify-content-center">
                <div class="admin_card position-relative">
                    <div class="d-flex justify-content-center admin-card-image">
                        <img class="rounded-circle vcard_card_five_thumb "
                             src="{{ !empty($vcard->profile_image) ? $vcard->profile_image : $data['user']->profile_image }}"
                             alt="Thumb">
                    </div>
                    <div class="content">
                        <div class="admin-title">
                            <h5 class="text center mb-1">{{ $vcard->name }}</h5>
