...
@endsection
@section('page_css')
    <link href="{{ asset('assets/css/web/vcards/vcards-four.css') }}" rel="stylesheet" type="text/css"/>
@endsection
@section('content')
    <div class="container p-0">
        <div class="vcard-page-content position-relative">
            ...
            <div>
                <img src="{{ !empty($vcard->cover_image) ? $vcard->cover_image :  asset('assets/web/css/images/vcard_four.jpeg') }}"
                     class="vcard-page-banner vcard_bg_cover_four">
            </div>
            <div class="admin_wrapper_card d-flex justify-content-center">
                <div class="admin_card position-relative">
                    <div class="d-flex justify-content-center admin-card-image p-3">
                        <img class="rounded-circle vcard_card_four_thumb"
                             src="{{ !empty($vcard->profile_image) ? $vcard->profile_image : $data['user']->profile_image  }}"
                             alt="Thumb">
                    </div>
                    <div class="content row">
                        <div class="admin-title col-sm-6 px-sm-3 px-4 pt-3 pb-sm-3 pb-0">
                            <h5 class="text center mb-0">{{ $vcard->name }}</h5>
                            <span class="admin-position">{{ $vcard->occupation }}</span>
                        </div>
                        <p class="text-center admin-intro col-sm-6 px-sm-3 px-4 py-3 mb-0">
                            {!!  $vcard->introduction !!}
                        </p>
                    </div>
                </div>
