...
<link rel="stylesheet" href="{{ asset('assets/front/css/freelancer.css') }}" type="text/css"/>
<link rel="stylesheet" href="{{ asset('assets/front/css/colors.php?color=f7c25e') }}" type="text/css"/>
